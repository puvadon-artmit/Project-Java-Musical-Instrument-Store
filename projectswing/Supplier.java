		...
		addBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					// SQL Insert
					String sql = "INSERT INTO Supplier " + "(ID,Name,Address,Phone,Email) " + "VALUES (" + ""
		...
		editBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String Sql = "UPDATE Supplier SET  name='" + nameTxt.getText() + 
							"', address="+ addressTxt.getText() + "" +", email=" + emailTxt.getText()+ ", phone=" + phoneTxt.getText() 
		...
		deleteBtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					String sql = "DELETE FROM Supplier " + " WHERE ID=" + idTxt.getText();
